...
import yourproject.conf
from yourproject.algorithms.dqn import train_dqn
from yourproject.algorithms.replay_buffer import ReplayBuffer
...
wandb.init(
    project="tests",
    entity=yourproject.conf.entity,
    config={
        "experiment": "dqn",
        "num_envs": num_envs,
